...
const Footer = () => {
  return (
    <footer className="bg-dark text-white text-center p-3 foot">
      <div className="container d-flex flex-row gap-3 justify-content-between">
        <p className="mb-0" style={{lineHeight:"55px"}}>&copy; 2023 Sahil. All rights reserved.</p>
